...
2. **Initialize CI tracking**:
   - Create `.cursor/ci-results.md` to track progress
...
4. **For each check**:
   ...
   a. **Run the check**:
      ...
      - Log command and output to `.cursor/ci-results.md`
   ...
   f. **If fix unsuccessful after max attempts**:
      ...
      - Document in `.cursor/ci-results.md` for user review
...
The `.cursor/ci-results.md` file tracks:
