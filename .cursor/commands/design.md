...
Create a feature specification (`design.md`) in `.cursor/scopes/FeatureName/` following the spec-to-code workflow. This replaces asking "Should I create a Spec?" - this command IS the spec creation.
...
2. **Load memory documentation**:
   - Read `.cursor/memory/constitution.md` (mandatory)
...
4. **Create design.md**:
   - Location: `FEATURE_DIR/design.md` (e.g., `.cursor/scopes/20251121-123456-FeatureName/design.md`)
   - Structure:
     ```markdown
     # Feature: [FeatureName]
